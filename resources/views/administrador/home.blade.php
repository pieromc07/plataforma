...
<div class="row" >
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4"  >
    ...
    <p style="color: white"> {{$administrador->apellido}} {{$administrador->nombre}} <br>Secretaria</p>  
      ...
      <nav class="mt-2">
        ...
        <li class="nav-item">
            ...
            <ul class="nav nav-treeview">
              <li class="nav-item">
                <a href="{{ route('fase1',$administrador->idadministrador) }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>  Verificar los datos (list FASE 01)</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="{{ route('fase3',$administrador->idadministrador) }}" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>Documento para Entregar   (list FASE 03)</p>
                </a>
              </li>
            </ul>
          </li> 
